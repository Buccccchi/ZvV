...
execute positioned 0 66 -200 rotated as @e[tag=Axis2,limit=2] rotated ~90 0 positioned ^ ^ ^2 rotated as @e[tag=Axis2,limit=2] run particle minecraft:dust{color: [5.0, 5.0, 5.0], scale: 1.0} ^ ^ ^2 0.2 0.2 0.2 0 30
