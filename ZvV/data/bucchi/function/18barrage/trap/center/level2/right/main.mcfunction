...
execute positioned 0 66 -200 rotated as @e[tag=Axis2,limit=2] rotated ~90 0 positioned ^ ^ ^1 rotated as @e[tag=Axis2,limit=2] positioned ^ ^ ^1 facing 0 66 -200 positioned 0 66 -200 positioned ^ ^ ^1 rotated as @e[tag=Axis2,limit=2] positioned ^ ^ ^1 facing 0 66 -200 positioned 0 66 -200 run particle minecraft:dust 5 5 5 1 ^ ^ ^2 0.2 0.2 0.2 0 10
