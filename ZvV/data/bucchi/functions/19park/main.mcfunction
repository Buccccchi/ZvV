...
#滑り台
scoreboard players add @e[tag=slide] obj 1
...
execute if entity @e[tag=slide,scores={obj=17}] as @e[tag=slide,scores={obj=17}] run function bucchi:19park/trap/slide/end
#試合終了
