...
summon minecraft:shulker 105 -64 -196 {Tags: ["seesaw"], NoAI: 1b, Silent: 1b, Invulnerable: 1b, ActiveEffects: [{Id: 14b, Amplifier: 0b, Duration: 2147483647, ShowParticles: 0b}]}
