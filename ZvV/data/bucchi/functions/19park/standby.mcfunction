team add park
summon minecraft:tropical_fish 107 64.7 -195.75 {Variant: 0, NoAI: 1b, Silent: 1b, Invulnerable: 1b, ActiveEffects: [{Id: 14b, Amplifier: 0b, Duration: 2147483647, ShowParticles: 0b}]}
summon minecraft:tropical_fish 107 64.7 -195.25 {Variant: 0, NoAI: 1b, Silent: 1b, Invulnerable: 1b, ActiveEffects: [{Id: 14b, Amplifier: 0b, Duration: 2147483647, ShowParticles: 0b}]}
...
summon minecraft:turtle 93 67.9 -191.65 {Tags: ["swing3"], Leash: {X: 93, Y: 70, Z: -192}, Age: -2147483648, NoAI: 1b, Silent: 1b, Invulnerable: 1b, ActiveEffects: [{Id: 14b, Amplifier: 0b, Duration: 2147483647, ShowParticles: 0b}]}
summon minecraft:turtle 92 67.9 -191.65 {Tags: ["swing4"], Leash: {X: 92, Y: 70, Z: -192}, Age: -2147483648, NoAI: 1b, Silent: 1b, Invulnerable: 1b, ActiveEffects: [{Id: 14b, Amplifier: 0b, Duration: 2147483647, ShowParticles: 0b}]}
#召喚
