summon minecraft:area_effect_cloud ~ ~2 ~ {Tags: ["potion2"], Particle: "minecraft:dragon_breath", ReapplicationDelay: 20, Radius: 2.0f, Duration: 100, Effects: [{Id: 6b, Amplifier: 0b, Duration: 1, ShowParticles: 0b}]}
